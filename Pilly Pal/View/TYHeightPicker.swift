...
class TYHeightPicker: UIView {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.backgroundColor = #colorLiteral(red: 0.1618608534, green: 0.8007312417, blue: 1, alpha: 1)
    ...
    override init(frame: CGRect) {
        ...
        indicatorView = createView(#colorLiteral(red: 0.1618608534, green: 0.8007312417, blue: 1, alpha: 1))
